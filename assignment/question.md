...
Hero: Lojaine the Warrior
Student ID: 16003064
GitHub account: lojainesoliman

A **Chimera** bars the way near **the Delta marshes**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Delta marshes, the Chimera flees!"
